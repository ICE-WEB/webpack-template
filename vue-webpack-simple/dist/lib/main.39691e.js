...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["default"].Store({
	state: { name: 'HELLO' },
	mutations: {
		updaeName: function updaeName(state, val) {
			state.name = val;
		}
	}
});
