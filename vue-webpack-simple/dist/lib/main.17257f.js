...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["default"].Store({
	state: { name: 'HELLO' },
	mutations: {
		updateName: function updateName(state, val) {
			state.name = val;
		}
	}
});
